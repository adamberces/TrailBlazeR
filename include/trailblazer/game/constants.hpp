...
struct Constants_s
{
    ...
    static constexpr float FRICITON_COEFFICIENT_Z = 25.F;
    ...
    static constexpr float START_POSITION_Y = 2.F;
    static constexpr float START_POSITION_Z = 2.F;
    static constexpr float START_VELOCITY = 1.F;
    static constexpr float SPEEDUP_ADDED_VELOCITY = 0.1F;
    static constexpr float JUMP_VELOCITY = 3.F;
