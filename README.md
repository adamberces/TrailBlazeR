...
## Messaging
The most important part of the game (other than the graphics engine) is the `messaging` component. It is a realization of the Observer pattern, with a twist using modern template-driven features like `std::any`.
